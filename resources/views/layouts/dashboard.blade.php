            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li >
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Consultar cadastros<span class="fa arrow"></span></a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="#">Cliente <span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="{{url('cadastrar/pessoa/fisica')}}">Pessoa Física</a>
                                        </li>
                                        <li>
                                            <a href="{{url('cadastrar/pessoa/juridica')}}">Pessoa Jurídica</a>
                                        </li>
